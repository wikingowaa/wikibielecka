...
library1 = Library("Zabrzeg", "Majowa", "23456",
                   "9:00  - 17:00", "123-456-789")
library2 = Library("Pszczyna", "Piłsudskiego", "67890",
                   "10:00 - 16:00", "987-654-321")

employee1 = Employee("Amelia", "Klapewska", "2022-01-01",
                     "2002-10-01", "Bytom", "Bytomska", "12345", "111-345-678")
employee2 = Employee("Agata", "Rumianek", "2022-01-02",
                     "1996-02-15", "Tarnowskie Góry", "Różana",
                     "52321", "432-456-786")
employee3 = Employee("Kuba", "Kowalski", "2022-01-03",
                     "1998-07-10", "Gdańsk", "Krokusowa",
                     "23345", "457-858-956")
